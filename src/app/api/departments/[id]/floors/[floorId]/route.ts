...
// DELETE a floor
export async function DELETE(_req: NextRequest, { params }: { params: Promise<{ id: string; floorId: string }> }) {
    ...
    await sql`DELETE FROM floors WHERE id = ${floorId} AND department_id = ${id}`;
